...
require_once base_path() . '/vendor/facebook/php-sdk/src/base_facebook.php';

use BaseFacebook;
use Session;

// Inspired from vendor/facebook/php-sdk/src/facebook.php ; just modified the way to access Session
class FacebookApi extends BaseFacebook {
    ...
    protected function getPersistentData($key, $default = false)
    {
        ...
        return Session::has($session_var_name) ? Session::get($session_var_name) : $default;
    }
